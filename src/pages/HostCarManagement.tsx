                    ...
                    {[
                      ...
                      <div key={i} className="group rounded-2xl border border-border/50 bg-card/80 backdrop-blur-sm p-4 relative">
                        ...
                        <button
                          ...
                          className="peer absolute bottom-2 right-2 z-10 inline-flex h-7 w-7 items-center justify-center rounded-full bg-muted/40 text-muted-foreground/70 transition-colors hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                        >
                      ...
                      return (
                        <div key={earning.id} className="rounded-2xl border border-border/50 bg-card/80 backdrop-blur-sm overflow-hidden transition-all duration-200 hover:border-primary/20 hover:shadow-sm">
                          <div className="p-3 sm:p-4 space-y-3">
                            {/* Header row: type/trip/status + amount + actions */}
                            <div className="flex items-start gap-2">
                              ...
                              <div className="flex items-center gap-1 shrink-0">
                                <div className="text-right">
                                  <p className="text-lg font-bold text-foreground tabular-nums leading-none">${earning.amount.toFixed(2)}</p>
                                  <p className="text-[10px] text-muted-foreground uppercase tracking-wider mt-0.5">Amount</p>
                                </div>
                                <DropdownMenu>
                                  <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" size="sm" className="h-8 w-8 p-0 rounded-xl">
                            ...
                            {/* Meta: guest, contact (tap-to-reveal), dates, source */}
                            <div className="space-y-1.5">
                              {(earning.guest_name || earning.guest_phone || earning.guest_email) && (
                                <div className="flex items-center gap-2 flex-wrap">
                                  {earning.guest_name && (
                                  ...
                                  <ContactReveal phone={earning.guest_phone} email={earning.guest_email} />
                                </div>
                              )}
                              <div className="flex items-center gap-x-3 gap-y-1 flex-wrap text-[11px] text-muted-foreground">
                                ...
                                <span>Source: {earning.payment_source}</span>
                                {earning.date_paid && (
