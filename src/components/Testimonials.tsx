...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    comment: "Teslys has completely transformed my Tesla into a revenue-generating asset. It brings in meaningful monthly income while they handle everything - cleaning, guest support, maintenance scheduling. Best decision I've made!",
    date: "2024-11-01",
  ...
  },
  {
    ...
    rating: 5,
    comment: "I was skeptical about car sharing, but Teslys's full-service approach won me over. They treat my Model S like their own, handle all maintenance scheduling, and provide detailed analytics. The monthly payouts have been consistent for my vehicle.",
    date: "2024-10-28",
