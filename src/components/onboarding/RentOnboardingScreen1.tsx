import { Percent, CalendarDays, CalendarRange, CalendarClock } from "lucide-react";
import { useEffect, useState } from "react";

export function RentOnboardingScreen1() {
    ...
    <div className="flex flex-col items-center justify-center min-h-full px-6 py-8 sm:py-12 text-center relative">
      ...
      >
        ...
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary/20 to-accent/20 backdrop-blur-sm flex items-center justify-center border border-primary/30">
          <Percent className="w-9 h-9 text-primary drop-shadow-lg" strokeWidth={2.5} />
        </div>
      </div>
      ...
      >
        Discounted rates on longer stays — the more days you rent, the more you save.
      </p>

      <div className="space-y-3 w-full max-w-sm">
        {[
          { icon: CalendarDays, title: "Daily Rentals", desc: "Flexible pickup, transparent pricing", delay: 0 },
          { icon: CalendarRange, title: "Weekly Rentals", desc: "Save up to 25% vs. daily rates", delay: 100 },
          { icon: CalendarClock, title: "Monthly Rentals", desc: "Save up to 40% — perfect for extended trips", delay: 200 },
