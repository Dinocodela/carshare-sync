import { BatteryCharging, BatteryLow, Zap, CheckCircle2 } from "lucide-react";
import { useEffect, useState } from "react";

export function RentOnboardingScreen3() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-full px-6 py-8 sm:py-12 text-center relative">
      ...
      >
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-accent/20 to-primary/20 backdrop-blur-sm flex items-center justify-center border border-primary/30 relative">
          <BatteryCharging className="w-9 h-9 text-primary drop-shadow-lg" strokeWidth={2.5} />
          <div
      ...
      >
        Drop it off at any battery level. No recharge fees, no last-minute Supercharger detours.
      </p>

      <div className="space-y-3 w-full max-w-sm">
        {[
          { icon: BatteryLow, title: "Return at Any Level", desc: "Even at 5% — we take it from there", delay: 0 },
          { icon: Zap, title: "No Recharge Fees", desc: "We handle charging between rentals", delay: 100 },
          { icon: CheckCircle2, title: "No Mandatory Stops", desc: "Skip the pre-return Supercharger detour", delay: 200 },
