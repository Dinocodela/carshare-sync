-- Fix the handle_new_user trigger to properly handle admin_name from host registrations
...
-- Update current user's profile to extract name from admin_name metadata
UPDATE public.profiles 
SET first_name = 'Arturo',
    updated_at = now()
