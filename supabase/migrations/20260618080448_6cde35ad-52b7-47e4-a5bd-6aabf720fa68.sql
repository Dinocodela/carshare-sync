CREATE OR REPLACE FUNCTION public.get_host_claims_page(p_car_id uuid DEFAULT NULL::uuid, p_claim_status text DEFAULT NULL::text, p_claim_type text DEFAULT NULL::text, p_date_from date DEFAULT NULL::date, p_date_to date DEFAULT NULL::date, p_limit integer DEFAULT 10, p_offset integer DEFAULT 0)
 RETURNS jsonb
 LANGUAGE plpgsql
