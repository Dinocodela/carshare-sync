...
DROP TRIGGER IF EXISTS validate_earning_dates_insert ON public.host_earnings;
DROP TRIGGER IF EXISTS validate_earning_dates_update ON public.host_earnings;
